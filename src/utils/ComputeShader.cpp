 ...
 * @author Angel Uriot
 * @date 2021-10-16
 * @link https://github.com/angeluriot/Galaxy_simulation/blob/master/sources/ComputeShader.cpp
 */
...
void ComputeShader::init(const std::string &path)
{
    ...
    cl::Program::Sources sources(1, src); // std::make_pair(src.c_str(), src.length() + 1)
